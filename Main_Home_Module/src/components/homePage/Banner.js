            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1> <span className="txt-rotate" dataPeriod="1000" data-rotate='[ Who are we? ]'><span className="wrap">{text}</span></span></h1>
                  <p className="fs-5">Oytie is a private organization that was founded in the year 2015. The company is all set to start training services for various IT courses. Information Technology is gradually infiltrating every part of our work and it’s likely to continue to do so in the future. It is helping to automate manual tasks, so processes run more efficiently, it enables us to make intelligent decisions faster, and much more.</p>
